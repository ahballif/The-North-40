                ...
                VStack {
                    if sortByGoals { //the two sort by options are different enough to render differently.
                        ...
                        List {
                            ...
                            let overDueSet = UserDefaults.standard.bool(forKey: "reportablesOnTodoList") ? overDueTodos + overDueReportables : overDueTodos
                            ...
                            ForEach(0..<numberOfDaysAhead, id: \.self) {i in
                                ...
                                let daySet = UserDefaults.standard.bool(forKey: "reportablesOnTodoList") ? todosToday + reportablesToday : todosToday
